 ...
 * @date 2020/04/16
 */
public class ComposeCache extends AbstractValueAdaptingCache {
     ...
     */
    protected ComposeCache(String name, Cache localCache, Cache remoteCache, boolean allowNullValues) {
